...
- 単語を長押しすると辞書を表示。iPhoneの「調べる」「翻訳」(既定)と、Claudeによる文脈に沿った語彙解説を設定で切り替え

  iPhoneの辞書で和訳を出すには、iOSの設定 → 一般 → 辞書で英和辞典を有効にしてください。長押しメニューの「翻訳」は辞書設定なしで使えます。
...
**画面設計**
- 英文・和訳をコンテンツ層として大きく表示し、操作系は下部の半透明なコントロール層に退避
